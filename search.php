        ...
        <div id="Articlesinfo" class="indx-bdr-b">
            <!--ด้านแท็กรูป-->
                <div class="col-md-10 col-md-offset-1">
                  <div class="row">
                    <div class="col-md-12">
                      <div id="serchShows" class="index-block">
                        <div class="row topic-item">
                            <div class="col-lg-12">
                              <div class="row">
                                <span class="titlehead">Serach Anime</span>
                              </div> 
                            </div>
                            <div class="col-lg-12">
                              <div class="row">
                                <?php 
                                      ...
                                      $sql = "SELECT *
                                              FROM tb_anime WHERE tb_anime_name_hi LIKE '%".$submit_Search."%'";
                                ...
                                <div class="col-lg-11">
                                  <div class="topic-item">
                                    <div class="media">
                                      <a class="media-left" href="animeinfo.php?idtb_anime_id=<?php echo $result["idtb_anime_id"];?>">
                                        <img src="http://localhost/Testweb/<?php echo $result["tb_anime_Picture"];?>" class="img-rounded" alt="<?php echo $result["tb_anime_name_hi"];?>" width="75" height="95">
                                      </a>
                                      <a class="media-body" href="animeinfo.php?idtb_anime_id=<?php echo $result["idtb_anime_id"];?>">
                                        <span class="title"><?php echo $result["tb_anime_name_hi"];?></span>
                                        <span class="article-meta"><?php echo substr_replace($result["tb_anime_Synopsis"],'...',40);?></span>
                                      </a>
                                    </div>
                                  </div>
                                </div>
