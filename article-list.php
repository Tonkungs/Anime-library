      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="article-list.php">Article List <span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Article List</h1>
            ...
            <table class="table table-hover table-admin">
              ...
              <tr>
                <td><?php echo $t++;?></td>
                <td><?php echo $result["tb_article_name"];?></td>
                <td><a type="button" class="btn btn-primary" href="admin-add-article.php?idtb_article=<?php echo $result["idtb_article"];?>" name="Submit_edit">Edit</a>
                    <a type="button" class="btn btn-danger"  href="function.php?didtb_article=<?php echo $result["idtb_article"];?>" name="Submit_Delete">Delete</a>
                </td>
              </tr>
              <?php }?>
            </table>
