      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="admin-add-article.php">Add/Edit Article</a></li>
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Arcticle</h1>
            <div class="col-md-7 ">
              <form class="form-horizontal" role="form" action="function.php" method="post">
            <?php 
            if ($_GET["idtb_article"]!=""){ 
                ...
                $sql = "SELECT * FROM tb_article WHERE idtb_article = '".$strarticleID."' ";
                $query = mysqli_query($conn,$sql);
                $result=mysqli_fetch_array($query,MYSQLI_ASSOC);
              ?>
              <div class="col-md-12">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Arcticle Name</label>
                    <div class="col-sm-8">
                    <input class="form-control" name="inputArcticleName" value="<?php echo $result["tb_article_name"];?>">
                    <input class="form-control" type="hidden" readonly="readonly" name="inputidtb_article" value="<?php echo $result["idtb_article"];?>">
                    <input class="form-control" type="hidden" readonly="readonly" name="inputName" placeholder="Arcticle Name" value="<?php echo $result["tb_member_idtb_member"];?>">
                    <input type="hidden" readonly="readonly" class="form-control" name="time" readonly="readonly"value="<?php echo $DateResultNow;?>">
                    </div>
                </div>
                <textarea class="form-control" rows="8" name="inputArcticle" ><?php echo $result["tb_article"];?></textarea>
                  <div class="col-md-1 col-md-offset-3">
                   <button type="Submit" class="btn btn-success btnfont" name="Submit_Arcticle_edit">Send</button>
                  </div>
              </div>
             <?php } else {?>
             <div class="col-md-12">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Arcticle Name</label>
                    <div class="col-sm-8">
                    <input class="form-control" name="inputArcticleName" placeholder="Arcticle Name">
                    <input class="form-control" name="inputName" type="hidden" readonly="readonly" value="<?php echo $_SESSION['id_member'];?>">
                    </div>
                </div>
                <textarea class="form-control" rows="8" name="inputArcticle"></textarea>
                  <div class="col-md-1 col-md-offset-3">
                   <button type="Submit" class="btn btn-success btnfont" name="Submit_Arcticle">Send</button>
                  </div>
              </div>
             <?php } ?>
              </form>
