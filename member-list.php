  ...
  <body itemscope itemtype="http://schema.org/WebPage ">  <!--ตรง inverse กำหนดสี เป็นสีดำ -->
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="member-list.php">Member List</a></li>
          ...
          <h1 class="page-header">Member List</h1>
            ...
            <table class="table table-hover table-admin">
              <tr class="info">
                ...
                <td>Member Name</td>
                <td>Type</td>
                <td class="table-4">Action</td>
              </tr>
              <?php while($result=mysqli_fetch_array($query,MYSQLI_ASSOC)){ $i++?>

              <tr>
                <td><?php echo $i;?></td>
                <td><?php echo $result["tb_member_id"];?></td>
                <td><?php echo $result["tb_member_type"];?></td>
                <td><a type="button" class="btn btn-primary" href="admin-add-member.php?idtb_member=<?php echo $result["idtb_member"];?>" name="Submit_edit">Edit</a>
                  <a type="button" class="btn btn-danger" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='function.php?didtb_member=<?php echo $result["idtb_member"];?>';}" name="Submit_Delete">Delete</a>
                </td>
              </tr>
              <?php }?>
            </table>
