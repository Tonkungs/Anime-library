...
<html lang="th">
  <head>
    ...
    <title><?php echo $result["tb_anime_name_hi"];?></title>
  ...
  <body itemscope itemtype="http://schema.org/WebPage ">  <!--ตรง inverse กำหนดสี เป็นสีดำ -->
      ...
      <div class="header" >
        ...
        <!-- Modal -->
      <div class="jumbotron" style="background-image: url(<?php echo $result["tb_anime_Picture_Head"];?>);"> 
        <div class="container">
          <div class="row">
            <div class="col-md-5">
              <div class="col-md-12">
                <span class="titlelead"><?php echo $result["tb_anime_name_hi"];?></span>
              </div>
              <div class="col-md-12 col-sm-8 col-xs-7 ">
                <span class="leads"><?php echo substr_replace($result["tb_anime_Synopsis"],'...',280);?></span>
              </div>
              <div class="col-md-7 col-sm-7 col-xs-7 titlelead">
                <div class="embed-responsive embed-responsive-16by9">
                  <iframe id="animeSmallThumbnail7" class="animeSmallThumbnail" frameborder="0" allowfullscreen="1" title="YouTube video player" width="240" height="135" src="https://www.youtube.com/embed/<?php echo $result["tb_anime_vdo"];?>?autoplay=1&amp;autohide=1&amp;showinfo=0&amp;modestbranding=1&amp;cc_load_policy=1&amp;rel=0&amp;controls=1&amp;enablejsapi=1&amp;"></iframe>
                </div>
              </div>
              </div>
            </div>
...
<!--col-md-10 คือมีความกว้างเท่าไร  col-md-offset-1 ห่างจากด้านซ้ายเท่าไร-->   
        <div id="animeinfo" class="indx-bdr-b">
            <div class="row topic-item">
              <div class="row">
                ...
                <div class="col-md-3 ">
                  <div class="col-md-12">
                    <img src="http://localhost:800/testweb/<?php echo $result["tb_anime_Picture"];?>" class="img-rounded imagean indx-bdr-b" alt="<?php echo $result["tb_anime_name_hi"];?>" width="210" height="340">
                  </div>
                </div>
                <div class="col-md-9 indx-bdr-l">
                  <div class="col-md-12">
                    <span class="animename "><?php echo $result["tb_anime_name_hi"];?></span>
                  </div>
                  <div class="col-md-12 indx-bdr-b">
                    <div class="detail">
                      <div class="detail-label">Genres:</div>
                      <div class="detail-content">
                        <div class="genre label label-info"><?php echo $result["tb_anime_genres"];?></div>
                      </div>
                    </div>
                    <div class="detail">
                      <div class="detail-label">Type/Status:</div>
                        <div class="detail-content ">
                            <?php echo $result["tb_anime_Type"];?>S
                        </div>
                      </div>
                    <div class="detail">
                      <div class="detail-label">Synopsis</div>
                        <div class="detail-content "><?php echo $result["tb_anime_Synopsis"];?>
                        </div>
                    </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-7 ">
                      ...
                      <div class="col-md-12 ">
                        <?php $ssql="SELECT tb_comment_anime.tb_comment_com,tb_comment_anime.tb_member_idtb_member,tb_comment_anime.tb_comment_time,tb_comment_anime.tb_anime_idtb_anime_id,tb_member.idtb_member,tb_member.tb_member_id
                                    ...
                                    where tb_anime_idtb_anime_id=$stridtb_anime_id
                      ...
                      ?>
                        <div class="article-item">
                          <div class="comment-member">
                            <div class="comment-mem"><?php echo $sresult['tb_comment_com'];?></div>
                    ...
                    <div class="col-md-5 ">
                      ...
                      <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="function.php" method="post">
                          ...
                          <input class="form-control" name="inputidtb_anime" type="hidden" readonly="readonly" value="<?php echo $stridtb_anime_id;?>">
                          <div class="col-md-1 col-md-offset-3">
                           <button class="btn btn-primary btnfont" type="submit" name="submit_comment_anime">Send</button>
                        </div>
                        </form>
